...
const features = [
  ...
  { icon: Users, title: "Advocacy Groups", description: "Discover and join YDAC advocacy groups aligned with your passions and causes." },
  { icon: Calendar, title: "Event Management", description: "Browse upcoming events, register online, and track your participation history." },
  { icon: GraduationCap, title: "Scholarship Finder", description: "Search and apply for educational assistance through the San Mateo scholarship portal." },
  { icon: BarChart3, title: "Participation Tracking", description: "Monitor your engagement across programs and build your volunteer portfolio." },
  { icon: Shield, title: "RA 10742 Compliant", description: "Built to support the SK Reform Act with scalable, standardized youth governance tools." },
];

const samplePrograms = [
  { title: "Youth Leadership Summit 2026", sector: "LYDO", description: "A three-day intensive leadership development program for aspiring youth leaders in San Mateo.", date: "March 15-17, 2026", location: "San Mateo Town Hall", type: "event" as const },
  ...
  { title: "San Mateo Educational Grant", sector: "Educational Assistance", description: "Financial assistance for deserving college students residing in San Mateo, Rizal.", date: "April 1-30, 2026", type: "scholarship" as const },
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:block animate-float">
              <img src={heroImage} alt="Filipino youth volunteers collaborating together" className="rounded-2xl shadow-2xl w-full" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">Everything Youth Need in One Place</h2>
            <p className="text-muted-foreground leading-relaxed">From discovering programs to tracking participation, LYDO Connect streamlines youth engagement for the Municipality of San Mateo.</p>
          </div>
      ...
      <section className="py-20 md:py-28 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-4">
            <div>
              <span className="text-xs font-semibold text-primary uppercase tracking-widest mb-3 block">Opportunities</span>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground">Programs, Events & Scholarships</h2>
            </div>
      ...
      <section className="py-20 md:py-28 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            <span className="text-xs font-semibold text-primary uppercase tracking-widest mb-3 block">Our Sectors</span>
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">Serving the Youth of San Mateo</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
