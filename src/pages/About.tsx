      ...
      <div className="pt-16">
        <section className="hero-gradient py-16 md:py-24">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-heading font-bold text-secondary-foreground mb-6">
            ...
            <p className="text-secondary-foreground/70 text-lg leading-relaxed">
              ...
              Metro Manila Local Youth Development Offices to consolidate youth programs, events, and organizations
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Youth programs in Metro Manila are promoted across fragmented channels, including separate Facebook
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  services offered by Metro Manila LYDOs and partner youth groups.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <FeatureCard icon={Users} title="Metro Manila" description="Youth engagement across LYDOs" />
                ...
                {[
                  {
                    ...
                    desc: "The central coordinating body responsible for youth development policies, programs, and services across Metro Manila LGUs.",
                  },
                  {
                    name: "LYDC",
