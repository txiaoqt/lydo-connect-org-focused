      ...
      <div className="pt-16">
        <section className="hero-gradient py-16 md:py-24">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-heading font-bold text-secondary-foreground mb-6">About LYDO Connect</h1>
            <p className="text-secondary-foreground/70 text-lg leading-relaxed">
              LYDO Connect is a centralized digital platform developed for the Municipality of San Mateo, Rizal to consolidate youth programs, events, and scholarships — improving information dissemination, coordination, and digital governance for Local Youth Development Offices.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-4">Why LYDO Connect?</h2>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  LYDO Connect solves this by providing a single, searchable, role-based platform that connects youth with the programs, events, and scholarships offered by LYDO, LYDC, YDAC, and the San Mateo Rizal Educational Assistance Unit.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                ...
                <FeatureCard icon={Award} title="300+" description="Scholarships granted" />
              </div>
            </div>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { name: "SMREAU", full: "San Mateo Rizal Educational Assistance Unit", desc: "The unit handling scholarship grants and financial assistance for deserving students in the municipality." },
                ].map((sector) => (
            ...
            <div className="max-w-3xl mx-auto mt-20 text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                LYDO Connect is designed in compliance with Republic Act 10742 (Sangguniang Kabataan Reform Act of 2015), ensuring that youth governance tools are standardized, scalable, and adaptable for implementation by other Local Youth Development Offices nationwide.
              </p>
            </div>
          </div>
        </section>
